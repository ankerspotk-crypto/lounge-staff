...
var MANUAL_DEFAULTS_ = [
  ...
  { ch: '開店前', emoji: '🌅', items: [
    ...
    ['19:45 外看板・外照明を点灯',
     '点け忘れが多い。カメラか目視で本当に点いているのを確認してから「完了」と報告する。\n見ずに「完了」と送るのが一番やってはいけない。', '重要', '開店前']
  ]},
  ...
  { ch: '退店・送り', emoji: '🚗', items: [
    ...
    ['2部営業（5階のみ・00:30〜02:00）',
     '2部に残れるキャストは黒服に報告する。さらに担当からお客様に2部利用の意思確認をしてもらう。\n料金：1部から残る場合は1名3,000円＋割物別＋キャスト分の席料。\n　　　2部から来店のお客様は10,000円＋割物別＋キャスト分の席料。', '重要', '2部']
  ]},
