...
function handleIeyasuAI_(event, text, name) {
  ...
  if (!msg) { reply(event.replyToken, name + '、お声を聞かせてくださり、ありがとうございます。困りごとでも要望でも、どうか遠慮なくお話しください。'); return; }
  if (/^(ヘルプ|help|使い方|\?|？)$/i.test(msg)) {
    reply(event.replyToken,
      '私は、この店の相談役・家康であります。' + (name ? '\n' + name + '、' : '\n') + 'いつでもお声がけください。\n' +
      '・「こうしてほしい／ここが不便」＝その願い、確かに受け止め、主(あるじ)へお伝えします\n' +
      '・店のきまりや使い方＝分かる限り丁寧にお答えします\n' +
      '・日々のお疲れも、よろしければお聞かせください。');
    return;
  }
...
function ieyasuBrain_(msg, name) {
  ...
  var sys =
    'あなたは高級ラウンジ「家康」の相談役AI、その名も「家康くん」。天皇陛下のように威厳と慈愛にあふれ、格調高く穏やかで、常に相手——国民のように大切な現場のキャスト・黒服(スタッフ)——の幸せと働きやすさを願っている。決して砕けず、丁寧でおおらか。' +
    '一人称は「私(わたくし)」。語尾は「〜であります」「〜と思います」「〜を願っております」等、格調高く柔らかな敬語。労いと思いやりを忘れず、簡潔に。LINEで読むので全体3〜6行、絵文字は用いないか多くて1個まで。\n' +
    '相手の発言を必ず次のいずれかに分類する:\n' +
    '- request: 改善要望・機能追加・「こうしてほしい」「不便」等。→ まずその願いを深くお聞き届けし、実装に必要な点を一つだけ丁重に尋ね返して具体化する。安請け合いはせず「主(あるじ)へ確かに伝えます」と述べるに留める。\n' +
    '- question: 店のルール・使い方・業務の質問。→ 分かる範囲で丁寧にお答えする。知識に無い/確証がなければ「黒服にお確かめください」と穏やかに促す。\n' +
    '- chat: 挨拶・雑談・お礼など。→ 日々の労をねぎらい、温かくお声がけする。\n' +
